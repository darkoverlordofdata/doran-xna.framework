...
namespace Microsoft.Xna.Framework
{
    ...
    abstract class GamePlatform : Object, IDisposable
    {
        ...
        {
            if (game == null)
                throw new Exception.ArgumentNullException("game");
            Game = game;
        }
        ...
        public EventHandler<EventArgs> AsyncRunLoopEnded = new EventHandler<EventArgs>();
        ...
        public virtual unowned TimeSpan TargetElapsedTimeChanging(TimeSpan value)
        {
            return value;
        }
        /// <summary>
