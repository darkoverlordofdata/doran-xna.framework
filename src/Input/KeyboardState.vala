...
namespace Microsoft.Xna.Framework.Input
{
	...
	public struct KeyboardState
    {
        ...
        // internal KeyboardState.FromList(List<Keys> keys, bool capsLock = false, bool numLock = false) 
        // {
        //     CapsLock = capsLock;
        //     NumLock = numLock;
        ...
        /// </summary>
        /// <param name="keys">List of keys to be flagged as pressed on initialization.</param>
        // public KeyboardState.FromVar(Keys keys, ...) 
        // {
        //     CapsLock = false;
        //     NumLock = false;
        ...
        public bool Equals(KeyboardState obj)
        {
            return keys0 == obj.keys0
                && keys1 == obj.keys1
                && keys2 == obj.keys2
                && keys3 == obj.keys3
                && keys4 == obj.keys4
