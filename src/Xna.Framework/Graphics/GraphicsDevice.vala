...
namespace Microsoft.Xna.Framework.Graphics
{
    public class GraphicsDevice : Object, IDisposable
    {
        ...
        private RenderTargetBinding[] _tempRenderTargetBinding = new RenderTargetBinding[1];
...
#else
        private static Color DiscardColor = new Color(0, 0, 0, 255);
#endif
        ...
        private List<WeakReference> _resources = new List<WeakReference>();
		...
		public EventHandler<ResourceCreatedEventArgs> ResourceCreated = new EventHandler<ResourceCreatedEventArgs>();
		public EventHandler<ResourceDestroyedEventArgs> ResourceDestroyed = new EventHandler<ResourceCreatedEventArgs>();
        public EventHandler<EventArgs> Disposing = new EventHandler<EventArgs>();

        internal EventHandler<PresentationEventArgs> PresentationChanged;
        ...
        public void Clear2(ClearOptions options, Color color, float depth, int stencil)
        {
		...
		public void Clear3(ClearOptions options, Vector4 color, float depth, int stencil)
		{
        ...
        */
        ...
        public void SetRenderTarget2(RenderTargetCube renderTarget, CubeMapFace cubeMapFace)
        {
            if (renderTarget == null)
            {
                SetRenderTargets(null);
        ...
        public void GetRenderTargetsOut(RenderTargetBinding[] outTargets)
        {
        ...
        public void SetVertexBuffer2(VertexBuffer vertexBuffer, int vertexOffset)
        {
        ...
        public void DrawUserPrimitives2<T>(PrimitiveType primitiveType, T[] vertexData, int vertexOffset, int primitiveCount, VertexDeclaration vertexDeclaration) // where T : struct
        {
            if (vertexData == null)
        ...
        /// For example a value of zero in the array of indices points to the vertex at index <paramref name="vertexOffset"/>
        /// in the array of vertices.</remarks>
        public void DrawUserIndexedPrimitives2<T>(PrimitiveType primitiveType, T[] vertexData, int vertexOffset, int numVertices, short[] indexData, int indexOffset, int primitiveCount, VertexDeclaration vertexDeclaration) // where T : struct
        {
        ...
        /// For example a value of zero in the array of indices points to the vertex at index <paramref name="vertexOffset"/>
        /// in the array of vertices.</remarks>
        public void DrawUserIndexedPrimitives3<T>(PrimitiveType primitiveType, T[] vertexData, int vertexOffset, int numVertices, int[] indexData, int indexOffset, int primitiveCount) // where T : struct, IVertexType
        {
            DrawUserIndexedPrimitives<T>(primitiveType, vertexData, vertexOffset, numVertices, indexData, indexOffset, primitiveCount, VertexDeclarationCache<T>.VertexDeclaration);
        }
        ...
        /// in the array of vertices.</remarks>
        public void DrawUserIndexedPrimitives4<T>(PrimitiveType primitiveType, T[] vertexData, int vertexOffset, int numVertices, int[] indexData, int indexOffset, int primitiveCount, VertexDeclaration vertexDeclaration) // where T : struct
        {
        ...
        public void GetBackBufferData2<T>(T[] data, int startIndex, int elementCount) // where T : struct
        {
            GetBackBufferData(null, data, startIndex, elementCount);
        }

        public void GetBackBufferData3<T>(Rectangle? rect, T[] data, int startIndex, int elementCount)
            // where T : struct
        {
            if (data == null)
                throw new ArgumentNullException("data");
