...
namespace Microsoft.Xna.Framework.Graphics
{
    public class DepthStencilState : GraphicsResource
    {
        ...
        private DepthStencilState.Named(string name, bool depthBufferEnable, bool depthBufferWriteEnable)
	    {
            this();
	        Name = name;
        ...
        private DepthStencilState.Cloned(DepthStencilState cloneSource)
	    {
