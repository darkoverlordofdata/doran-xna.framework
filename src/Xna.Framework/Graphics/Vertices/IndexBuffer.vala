...
namespace Microsoft.Xna.Framework.Graphics
{
    public class IndexBuffer : GraphicsResource
    {
		...
		public IndexBuffer(GraphicsDevice graphicsDevice, IndexElementSize indexElementSize, int indexCount, BufferUsage bufferUsage, bool dynamic=false) 
        {
		...
		// public IndexBuffer.Size(GraphicsDevice graphicsDevice, IndexElementSize indexElementSize, int indexCount, BufferUsage bufferUsage, bool dynamic=false) 
		// {
		// 	this(graphicsDevice, indexElementSize, indexCount, bufferUsage, dynamic)
		// }

        // Not Used...
		// public IndexBuffer.Type(GraphicsDevice graphicsDevice, Type indexType, int indexCount, BufferUsage usage, bool dynamic=false) 
		// {
		// 	// this(graphicsDevice, SizeForType(graphicsDevice, indexType), indexCount, usage, dynamic);
		// 	this(graphicsDevice, sizeof(int), indexCount, usage, dynamic);
		// }
        ...
        public void GetDataRange<T>(T[] data, int startIndex, int elementCount) // where T : struct
        {
            this.GetData<T>(0, data, startIndex, elementCount);
        }

        public void GetDataAll<T>(T[] data) // where T : struct
        {
		...
		public void SetDataRange<T>(T[] data, int startIndex, int elementCount) // where T : struct
        {
            SetDataInternal<T>(0, data, startIndex, elementCount, SetDataOptions.None);
		}
		
        public void SetDataAll<T>(T[] data) // where T : struct
        {
