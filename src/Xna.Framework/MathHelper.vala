...
namespace Microsoft.Xna.Framework
{
	...
	/// <summary>
 	...
 	/// <summary>
        ...
        {
            return Math.fabsf(value1 - value2);
        }
        ...
        public static float Maxf(float value1, float value2)
        {
        ...
        public static float Minf(float value1, float value2)
        {
            return value1 < value2 ? value1 : value2;
        }
        ...
        public static float SmoothStep(float value1, float value2, float amount)
        {
            ...
            float result = MathHelper.Clampf(amount, 0f, 1f);
