...
namespace Microsoft.Xna.Framework.Graphics
{
	...
	public class RenderTargetBinding : Object
	{
		...
		public RenderTargetBinding.From2D(RenderTarget2D renderTarget)
		{
			if (renderTarget == null) 
				throw new Exception.ArgumentNullException("renderTarget");
        ...
        public RenderTargetBinding(RenderTargetCube renderTarget, CubeMapFace cubeMapFace)
        {
            ...
            if (cubeMapFace < CubeMapFace.PositiveX || cubeMapFace > CubeMapFace.NegativeZ)
                throw new Exception.ArgumentOutOfRangeException("cubeMapFace");
        ...
        public static RenderTargetBinding RenderTarget2D(RenderTarget2D renderTarget)
        {
            return new RenderTargetBinding.From2D(renderTarget);
        }
