...
namespace Microsoft.Xna.Framework
{
    ...
    public class Color : Object //, IEquatable<Color>
    {
        ...
        public Color.Alpha(Color color, int alpha)
        {
            ...
            {
                var clampedA = (uint)MathHelper.Clamp(alpha, uint8.MIN, uint8.MAX);
        ...
        public Color.Alphaf(Color color, float alpha)
        {
            this.Alpha(color, (int)(alpha * 255));
        }
        ...
        public Color.Rgbf(float r, float g, float b)
        {
            this.Rgb((int)(r * 255), (int)(g * 255), (int)(b * 255));
        }
        ...
        public Color.Rgb(int r, int g, int b)
        {
            ...
            {
                var clampedR = (uint)MathHelper.Clamp(r, uint8.MIN, uint8.MAX);
                var clampedG = (uint)MathHelper.Clamp(g, uint8.MIN, uint8.MAX);
                var clampedB = (uint)MathHelper.Clamp(b, uint8.MIN, uint8.MAX);
        ...
        public Color.Rgba(int r, int g, int b, int alpha)
        {
        ...
        public uint8 B
        {
            ...
            {
                {
                    return (uint8) (this._packedValue >> 16);
                }
            }
            set
            {
        ...
        public uint8 G
        {
            ...
            {
                {
                    return (uint8)(this._packedValue >> 8);
                }
            }
            set
            {
        ...
        public uint8 R
        {
            ...
            {
                {
                    return (uint8) this._packedValue;
                }
            }
            set
            {
        ...
        public uint8 A
        {
            ...
            {
                {
                    return (uint8)(this._packedValue >> 24);
                }
            }
            set
            {
        ...
        {
            return (int)this._packedValue;//.GetHashCode();
        }
	...
	/// <summary>
        ...
        /// <param name="g"></param>
        /// <param name="b"></param>
        public void DeconstructRgb(out float r, out float g, out float b)
        {
            r = R;
            g = G;
            b = B;
        ...
        /// <param name="b"></param>
        /// <param name="a"></param>
        public void DeconstructRgba(out float r, out float g, out float b, out float a)
        {
            r = R;
            g = G;
            b = B;
